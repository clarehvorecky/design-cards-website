...
export function NotificationPopup({isOpen, onClose}){
    ...
    return(
        <div>
            <div style={{zIndex:10, width:"400px", height:"200px", backgroundColor:"rgba(250, 250, 250, 0.90)", position: "fixed", top: "50px",right: "50px", 
                ...
                <p>Please use Google Chrome, Microsoft Edge or Firefox for best downloading results!</p>
